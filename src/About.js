			...
			<main>
				...
				<div className={css.wrapper}>
					...
					<div className={css.blurb}>
						...
						<ul>
							<li><p>I have a BSc in <a href="https://www.auckland.ac.nz/en/study/study-options/find-a-study-option/logic-computation.html" target="_blank" rel="noreferrer">Logic & Computation</a> from The University of Auckland and am working towards an <a href="https://www.pratt.edu/academics/information/degrees/data-analytics-and-visualization-ms/" target="_blank" rel="noreferrer">MS in Data Analytics and Visualization</a> at Pratt.</p></li>
							<li><p>I'm engaged to the phenomenal <a href="http://www.cahalanejennifer.com/" target="_blank" rel="noreferrer">Jenny Cahalane</a> and we have a magnificent mutt <a href="http://scram142.neocities.org/" target="_blank" rel="noreferrer">Sir Tubias Pascal of Selby</a>.</p></li>
							<li><p>I used to perform for the circus, specialising in partner acrobatics and trapeze. These days I train at <a href="https://www.aerialartsnyc.com" target="_blank" rel="noreferrer">Aerial Arts NYC</a>.</p></li>
